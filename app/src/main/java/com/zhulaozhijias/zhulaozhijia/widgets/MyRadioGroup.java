...
public class MyRadioGroup extends LinearLayout {
    // holds the checked id; the selection is empty by defaults
    ...
    /**
     * set the defaults checked radio button, without notification the listeners
     * @param mCheckedId the defaults checked radio button's id, if none use -1
     */

...
public class HorizontalProgressBar extends View {
     ...
     * 进度条背景颜色
     */
    private int bgColor = 0xFFFFD4D4;
    /**
     * 进度条颜色
     */
    private int progressColor = 0xFFFB6D6D;
    ...
    private void initAnimation() {
        progressAnimator = ValueAnimator.ofFloat(mOldProgress, mProgress);
        //让进度条从停止处继续开始
        ...
        progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                df.format(value);
                textString = String.valueOf(df.format(value));
